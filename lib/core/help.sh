...
show_installer_help() {
    echo "Usage: nr installer [OPTIONS]"
    echo ""
...
show_optimize_help() {
    echo "Usage: nr optimize [OPTIONS]"
    echo ""
...
show_uninstall_help() {
    echo "Usage: nr uninstall [OPTIONS] [APP_NAME ...]"
    echo ""
    ...
    echo "For leftovers from apps that are already gone, use nr clean."
    echo ""
    echo "Examples:"
    echo "  nr uninstall                   Open interactive app selector"
    echo "  nr uninstall slack             Uninstall Slack"
    echo "  nr uninstall slack zoom        Uninstall Slack and Zoom"
    echo "  nr uninstall --dry-run slack   Preview Slack uninstallation"
    echo "  nr uninstall --list            Show installed apps and the names nr uninstall accepts"
    echo "  nr uninstall --yes slack       Uninstall without the confirmation prompt"
    echo ""
    echo "Options:"
    echo "  --list            List installed apps with the exact name nr uninstall accepts"
    echo "  --dry-run         Preview app uninstallation without making changes"
    echo "  --permanent       Bypass macOS Trash and rm -rf immediately"
    echo "  -y, --yes         Skip the confirmation prompt, for callers with no terminal"
